...
N = 1000  # 1000 realizations for stable statistics without taking too long

print("=== Running MEDIUM Subhalo Calibration Verification ===")
...
print(f"Shift in Variance (Brute): Option A = {shift_ab:+.2f}%, Option B = {shift_bb:+.2f}%")
