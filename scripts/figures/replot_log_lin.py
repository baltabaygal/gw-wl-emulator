...
print(f"Comparing in log-lin plane at: Om={Om}, h={h}, s8={s8}, z={z}")
...
ax.set_title(f"Lensing PDF Comparison (Log-Lin Plane) at z={z}, Om={Om}, s8={s8}, h={h}")
ax.legend()
ax.grid(True, which="both", ls="--", alpha=0.3)

plt.tight_layout()
os.makedirs("/Users/baltabay/Desktop/gw-wl-emulator/plots/figures", exist_ok=True)
plot_path = "/Users/baltabay/Desktop/gw-wl-emulator/plots/figures/compare_all_models_loglin.png"
fig.savefig(plot_path, dpi=200)
plt.close(fig)

print(f"Comparison plot (loglin) saved to {plot_path}")
