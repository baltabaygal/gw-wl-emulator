...
def generate_report():
    ...
    report = f"""# Statistical Stability and Dataset Validation Report
...
"""
    with open("docs/dataset_validation_report.md", "w") as f:
        f.write(report)

    print("Report generated at docs/dataset_validation_report.md")
